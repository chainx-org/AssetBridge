...
func (bc *ChainCore) GetSubChainRecipient(m msg.Message) (interface{}, error) {
...
func (bc *ChainCore) GetAmountFromSubToSub(origin []byte, assetId xevents.AssetId) (*big.Int, error) {
